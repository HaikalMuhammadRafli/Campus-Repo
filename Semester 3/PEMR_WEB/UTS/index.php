...
<body class="d-flex">
    <section id="sidebar"
        class="bg-prim h-100 d-flex flex-column justify-content-start align-items-center fixed-top pt-3">
        <i class="fa-brands fa-42-group text-white fs-4 mt-2"></i>
        <div class="mt-4"></div>
        <div id="create-btn" class="btn-add mt-2 rounded-circle d-flex justify-content-center align-items-center"
            style="padding:4px 5px ;"><i class="fa-solid fa-plus color-prim"></i></div>
    </section>
