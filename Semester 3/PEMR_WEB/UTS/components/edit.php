    <?php if (isset($note)) { ?>
        <section class="d-flex justify-content-between mx-3 mt-3">
            ...
            <button id="delete-btn" class="btn color-danger" data-id="<?= $note['id']; ?>"><i class="fa-solid fa-trash-can"></i></button>
        </section>
        <section class="mx-5">
            <form id="edit-note" action="controllers/update.php" method="POST">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input id="form-title-edit" type="text" name="title" class="form-title form-control border-0 rounded-0" value="<?= $note['title'] ?>" placeholder="Input title" aria-label="title">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <textarea id="form-content-edit" name="content" class="form-content form-control border-0 rounded-0" placeholder="Start typing..." rows="32"><?= $note['content'] ?></textarea>
                    </div>
                </div>
            </form>
        </section>
